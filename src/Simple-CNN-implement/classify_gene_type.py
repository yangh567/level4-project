"""
    ...
    This file is used to test on the self-build simple CNN model on the classification_cancer_analysis of genes
...
def process_data(data, cancer_type, gene_list, sbs_names, scale=True):
    ...
    for sbs_name in cfg.SBS_NAMES:
        # set the sbs that are not important to 0.01*value
