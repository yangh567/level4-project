...
use_columns = ['organ','CCND1', 'CCND2', 'CCND3', 'CCNE1', 'CDK4', 'CDK6', 'E2F1', 'E2F3', 'YAP1', 'MYC', 'MYCN', 'ARRDC1',
...
data = pd.read_csv('../../data/processed/sample_id.sbs.organ.csv',usecols = use_columns, low_memory = True)

data = data.fillna(0)
print(data.columns.tolist())

data.to_csv('small_data/small_data1.csv')
