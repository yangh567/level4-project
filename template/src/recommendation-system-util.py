...
courses_df = pd.read_csv("datafiles/courses.csv")
...
if __name__ == '__main__':
    queries = ['wp7-core', 'ef41-data-access', 'nosql-big-pic', 'procedural-ice-modeling-softimage-153','beginners-guide-shading-networks-softimage-510', 'centralized-logging-elastic-stack', 'apache-pig-data-transformations']
