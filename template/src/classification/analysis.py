...
#  Statistically calculate mean, find the sbs weight for each cancer types greater than
#  the mean and set it as 1,the rest will be 0
...
# Statistically calculate mean, find the sbs weight for gene mutation combination greater than the mean and set it as
# 1,the rest will be 0
